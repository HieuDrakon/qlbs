...
<html>
    ...
    <body>
        ...
        <div style=height: 200px; overflow-y: scroll;">
            <h3> action edit </h3> 
            <ul>  
                <li><button><a href="http://localhost:9999/QLCHGAS/Login?txtU=Hieu&txtP=123">return</a></button></li>
                <li><button><a href="/QLCHGAS/addsp2.jsp">ADD</a></button></li>
                <li><button><a href="http://localhost:9999/QLCHGAS/upsp2.jsp">edit</a></button></li>
            </ul>
        </div>
        <table border="1">
            <tr>
            ...
            <% 
                try {
                    ...
                    java.sql.Connection con = Action.ConServlet.getView2();
                    if (con != null) {
            ...
            <tr>
                ...
                <td><%= tgbh %></td>
                <td><%= dg %></td>
                <td><form action="de2" method="post">
